...
#
YAW_DEAD_ZONE = 10.0      # degrees — no scrub within this range
SCRUB_SPEED = 0.30        # seconds per frame at max head turn
...
#
PITCH_DEAD_ZONE = 12.0     # degrees — normal speed within this
MIN_SPEED = 0.2            # slowest playback (half speed)
MAX_SPEED = 3.0            # fastest playback (double speed)
